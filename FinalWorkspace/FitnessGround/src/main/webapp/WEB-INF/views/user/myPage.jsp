	...
	<div class="mypage_info col-md-3 col-md-offset-2 col-sm-12">
		<div class="mypage_info_title" align="center">
			<a href="javascript:profileEdit()">
				...
				<img src="/fitnessground/resources/images/myimages/nullicon.png" class="img-circle" style="background:#87798f;">
				</c:if>
				<c:if test="${ sessionScope.user.rename_image != null }">
				<img src="/fitnessground/resources/images/myimages/${sessionScope.user.rename_image}" class="img-circle" style="background:#87798f;">
				</c:if>
			</a>
