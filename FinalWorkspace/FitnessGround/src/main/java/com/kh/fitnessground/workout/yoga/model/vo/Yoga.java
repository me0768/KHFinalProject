...
public class Yoga {
	...
	public Yoga(int v_no, String title, String content, String category1, String category2, String url, int readcount) {
		super();
		this.v_no = v_no;
		this.title = title;
	...
	public String toString() {
		return "Yoga [v_no=" + v_no + ", title=" + title + ", content=" + content + ", category1=" + category1
