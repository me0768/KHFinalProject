    ...
    Toolbar.prototype.render = function () {
        ...
        if (sections) {
            ...
            el.append(this.renderSection('left'))
                ...
                .append('<div style="text-align:center;" class="col-sm-12" id="userSTitle"><div class="col-sm-12" style="margin-top:10px; text-align:center;"><a id="usLike">운동 동영상</a> 시청 후 <a id="usLike">좋아요</a> 버튼을 누르시거나, <a id="usIn">직접 입력</a>하여 운동 스케줄을 관리할 수 있습니다.</div></div>')
