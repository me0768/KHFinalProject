	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header" id="login_header">
				...
				<c:if test="${ sessionScope.user.rename_image != null }">
				<img id="profileEditImg" src="/fitnessground/resources/images/myimages/${ sessionScope.user.rename_image }" class="img-circle" style="background:#87798f; width:150px; height:150px; margin-top:20px;">
				</c:if>
