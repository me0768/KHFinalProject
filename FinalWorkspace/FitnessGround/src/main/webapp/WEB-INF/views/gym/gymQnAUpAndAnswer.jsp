...
<div class="col-md-offset-2 col-md-8 hidden-xs hidden-sm hidden-md visible-lg" id="gymQContent">
	...
	<table>
		...
		<tr>
			...
			<td colspan="2">
			<c:if test="${mode eq 1}">
				<textarea rows="15" class="form-control" name="content" onkeyup="ckWordLen(this, 10)">${board.content}</textarea>
			</c:if>
			<c:if test="${mode eq 2}">
				<textarea rows="15" class="form-control" name="content" onkeyup="ckWordLen(this, 10)"></textarea>
			</c:if>
			</td>
		</tr>
		<tr>
