   		...
   		$.ajax({
   			 ...
   			 success: function(data)
   			 {
   				 ...
   				 for(var i in data.cblist)
   					...
   					"<div class='col-md-6 text-center'>" +  data.cblist[i].content + "</div><div class='col-md-2 text-center'>" + data.cblist[i].reply_date
   					+ "</div><div class='col-md-2 text-right'><a class='btn' type='submit' onclick='communityCommentDelete("+data.cblist[i].cb_no+","+ data.cblist[i].cbc_no +")'>삭제</a></div>"
   					+"</div>";
   					 }
