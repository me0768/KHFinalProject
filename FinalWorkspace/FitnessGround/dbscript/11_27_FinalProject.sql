...
-- 시퀀스 생성 종료 --
<<<<<<< HEAD:FinalWorkspace/FitnessGround/dbscript/11_23_FinalProject.sql
  
=======

-- 샘플데이터 삽입 --
INSERT INTO TB_USER VALUES(USER_SEQ.NEXTVAL, 'ADMIN', '$2a$10$Fr8KsAskrldajwgHTaOvWeMfMhbamOVTQ9.1S2LN9M01g67zzd2im', '관리자', '관리자', '010-8366-3828', 2, NULL, 0);
...
END;
/
>>>>>>> master:FinalWorkspace/FitnessGround/dbscript/11_27_FinalProject.sql
