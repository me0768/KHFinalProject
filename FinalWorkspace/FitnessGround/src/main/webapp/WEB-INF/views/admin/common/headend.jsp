...
<link
	href="/fitnessground/resources/admin/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<!-- Custom fonts for this template-->
<link
	href="/fitnessground/resources/admin/vendor/font-awesome/css/font-awesome.min.css"
...
<link href="/fitnessground/resources/admin/css/sb-admin.css"
	rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="adminMain.do">Start Bootstrap</a>
	...
	<script
		src="/fitnessground/resources/admin/vendor/chart.js/Chart.min.js"></script>
	<script
